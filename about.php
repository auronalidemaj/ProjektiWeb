...
<?php 
  ...
  include 'header.php'?>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class ="card card2">
                    <h5>Cardio</h5>
                    <p class = "pg2">
                        The best morning is to start with cardio,
                        cardio in your morning .
                    </p>
                ...
                <div class ="card card3">
                    <h5>Discipline</h5>
                   <p class="pg3">
                       Is just choosing between what you want now
    ...
    <figure class="our-classes">
      ...
      <figure class="our-classes">
        <img src="img/gym-girl.jpg" alt="" />
        <figcaption>
          <h3>Gym</h3>
        </figcaption>
      </figure>
      <figure class="our-classes">
        <img src="img/pilates.jfif" alt="" />
        <figcaption>
          <h3>Pilates</h3>
        </figcaption>
      </figure>
  ...
  <div class = "paragrafi">
    ...
    <div class = "p3">We offer the best classes you can find out there.</div>
  </div>
  <div>
    <div class="coach">
      <div class="coach1">
